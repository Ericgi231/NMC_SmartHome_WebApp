		...
		<div class="col-lg-12">
			<div class="box fongle-blue">      
				<h2>Credit for Icons</h2>
					...
					<img src="./images/icons/002-wifi.svg" alt="wifi house" style="width:50px;"> <p>Smart home free icon created by: Freepik at www.flaticon.com</p>
					<img src="./images/icons/003-light-bulb.svg" alt="light bulb on" style="width:50px;"> <p>Light bulb free icon created by: Creaticca Creative Agency at www.flaticon.com</p>
					<img src="./images/icons/004-light-bulb-1.svg" alt="light bulb off" style="width:50px;"> <p> Light bulb free icon created by: Creaticca Creative Agency at www.flaticon.com</p>
					<img src="./images/icons/rain.svg" alt="rain" style="width:50px;"> <p>Humidity free icon created by: iconixar at www.flaticon.com</p>	 		
			</div>
		</div>
	</div>
</div>
