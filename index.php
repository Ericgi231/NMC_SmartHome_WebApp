	...
	<div class="row">
		<div class="col-lg-6">
			<div class="box fongle-blue">
				...
				<?php
					$sql = 'SELECT c.RecordTime, c.Humidity, c.Temperature, c.DeviceId, c.UserId AS FullId FROM Climate AS c WHERE c.UserId = ' . $_SESSION["id"] . ' ORDER BY RecordTime DESC LIMIT 1';
